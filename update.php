...
<body>
    ...
    $sql = "SELECT * from carsinfo where carID=:carId";
    //Prepare the query:
    ...
    ?>
            <form name="insertrecord" method="post" class="updateF">
                <div class="row">
                    <div class="col-md-4"><b>Image link</b>
                        <input type="text" name="image" value="<?php echo htmlentities($result->image); ?>" class="form-control" required>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4"><b>Price</b>
                        <input type="number" name="price" value="<?php echo htmlentities($result->price); ?>" class="form-control" required>
                    </div>
                    <div class="col-md-4"><b>Color</b>
                        <input type="text" name="color" value="<?php echo htmlentities($result->color); ?>" class="form-control" maxlength="10" required>
                    </div>
                </div>
        <?php }
    } ?>
        <div class="row" style="margin-top:1%">
            ...
            if (isset($_POST['update'])) {
                ...
                $update = "UPDATE `carsinfo` SET `image` =:img , `model` =:mdl , `price` =:pc, `color` =:clr WHERE `carsinfo`.`carID` = :carId;";
